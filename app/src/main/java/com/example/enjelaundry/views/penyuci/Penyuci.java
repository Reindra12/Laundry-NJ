package com.example.enjelaundry.views.penyuci;
...
import com.example.enjelaundry.adapter.AdpPenyuci;
...
public class Penyuci extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mpenyuci);
    ...
    private void tampil(String cari) {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, koneksi.penyuci,
                    ...
                    public void onResponse(String response) {
                        ...
                        if (response.contains("1")) {
                            try {
                                ...
                                JSONArray result = jsonObject.getJSONArray("penyuci");
                                //tampil.clear();
                                for (int i = 0; i < result.length(); i++) {//PR
                                    ...
                                    map.put("alamat", c.getString("alamat"));
                                    map.put("hp", c.getString("hp"));
                                    map.put("foto", c.getString("foto"));
                                    tampil.add(map);
                                }

                                adapter = new AdpPenyuci(Penyuci.this, tampil);
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(Penyuci.this, "Tidak terhubung ke server", Toast.LENGTH_SHORT).show();
                    }
                }) {
            @Override
