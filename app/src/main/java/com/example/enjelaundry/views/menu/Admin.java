...
public class Admin extends AppCompatActivity implements View.OnClickListener {
    ...
    LinearLayout btransaksi, briwayat, bsantri, bpencuci, blayanan, bkeluar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bsantri = findViewById(R.id.bsantri);
        bpencuci = findViewById(R.id.bpencuci);
        blayanan = findViewById(R.id.blayanan);
        ...
        bsantri.setOnClickListener(this);
        bpencuci.setOnClickListener(this);
        blayanan.setOnClickListener(this);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.btransaksi:
                intent = new Intent(Admin.this, Transaksi.class);
            ...
            case R.id.briwayat:
                ...
                break;
            case R.id.bsantri:
                intent = new Intent(Admin.this, Santri.class);
                startActivity(intent);
                break;
            case R.id.bpencuci:
                intent = new Intent(Admin.this, Penyuci.class);
                startActivity(intent);
                break;
            case R.id.blayanan:
                intent = new Intent(Admin.this, Layanan.class);
                startActivity(intent);
                break;
            case R.id.bkeluar:
